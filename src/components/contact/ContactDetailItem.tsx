...
export default async function ContactDetailItem({children, className, name, value}: Props) {
    return <div className={`border border-border-100 rounded-2xl gradient-container before:rounded-2xl ${className}`}>
