...
export default async function ToolItem({image, percentage, name}: Props) {
    return <div className="flex flex-col gap-2.5 p-5 bg-background-rgba-200 border border-border-100 rounded-2xl">
        <div className="size-18 mx-auto bg-position-[center_38%] bg-size-[40%_40%] bg-no-repeat sm:size-25" style={{backgroundImage: `url('${image}')`}}>
